...
<body>
    ...
    <c:if test="${not empty sessionScope.member}">
        <input type="hidden" value='${sessionScope.member.nick}' id='chat_id' />
    </c:if>
    ...
    <img class="chat" src="../uploadimg/img3.jpg" />
</body>
...
<script>
    $(".chat").on({
        "click" : function() {
            if ($(this).attr("src") == "../uploadimg/img3.jpg") {
                $(".chat").attr("src", "../uploadimg/img3.jpg");
                $("#_chatbox").css("display", "block");
            } else if ($(this).attr("src") == "../uploadimg/img3.jpg") {
                $(".chat").attr("src", "../uploadimg/img3.jpg");
